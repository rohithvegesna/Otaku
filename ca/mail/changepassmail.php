<?php
	...
	$ThePassResetLink = 'http://'.$_SERVER['SERVER_NAME'].'/ca/forgot.php?k='.md5(md5($Details['UserName']));
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <strong>Otaku:</strong> You have requested to change pasword please click the below button to change your password. Please ignore this mail if not requested to change password.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="$ThePassResetLink" target="_blank">Click here to Authenticate</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
